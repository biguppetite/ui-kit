...
import { CheckIcon, ArrowLeftIcon, XMarkIcon, ChevronDownIcon, StarIcon } from '@heroicons/react/24/solid';
...
var Button = function (_a) {
    var _b;
    var label = _a.label, btnType = _a.btnType, parentClassName = _a.parentClassName, child = _a.child, _c = _a.errors, errors = _c === void 0 ? [] : _c, link = _a.link, props = __rest(_a, ["label", "btnType", "parentClassName", "child", "errors", "link"]);
    var classMap = (_b = {},
...
var Checkbox = function (_a) {
    ...
    var _c = useState(!!checked), inChecked = _c[0], setInChecked = _c[1];
    ...
    return (jsxs("div", __assign({ className: "flex items-center ".concat(className) }, { children: [jsxs("div", __assign({ className: "relative" }, { children: [jsx("input", __assign({ id: name, name: name, placeholder: label, type: "checkbox", checked: inChecked, onChange: changeCheck }, props, { className: "form-checkbox ".concat(inputClassName, " ").concat(errors.length ? "form-input-error" : "") })), inChecked && (jsx("label", __assign({ htmlFor: name }, { children: jsx(CheckIcon, { className: "absolute cursor-pointer top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white w-4 font-bold" }) })))] })), label && (jsx("label", __assign({ className: "form-label ml-2 ".concat(labelClassName), htmlFor: name }, { children: label }))), child && child, errors.length > 0 && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var Input = function (_a) {
    ...
    var _c = useState(props.value), inValue = _c[0], setInValue = _c[1];
    var changeEvent = function (e) {
        setInValue(e.target.value);
        if (props.onChange)
            props.onChange(e);
    };
    return (jsxs("div", __assign({ className: className }, { children: [label && (jsx("label", __assign({ className: "form-label", htmlFor: name }, { children: label }))), jsxs("div", __assign({ className: "form-input ".concat(inputClassName, " ").concat(errors.length ? "form-input-error" : "") }, { children: [iconPosition !== 'right' && icon, jsx("input", __assign({}, props, { value: inValue, id: name, onChange: changeEvent, className: "border-none outline-none focus:outline-none flex-1" })), iconPosition === 'right' && icon] })), child && child, errors.length > 0 && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};

var Carousel = function (_a) {
    var props = __rest(_a, []);
    var items = props.items, itemsToShow = props.itemsToShow, speed = props.speed, showDotsNav = props.showDotsNav, controlClass = props.controlClass, leftControlClass = props.leftControlClass, rightControlClass = props.rightControlClass, leftControlIconClass = props.leftControlIconClass, rightControlIconClass = props.rightControlIconClass, containerClassName = props.containerClassName, activeSlideClassName = props.activeSlideClassName;
    var _b = useState(0), activeSlide = _b[0], setActiveSlide = _b[1];
    return (jsx("div", __assign({ className: "carouselContainer ".concat(containerClassName) }, { children: jsx(SimplyCarousel, __assign({ preventScrollOnSwipe: true, swipeTreshold: 60, activeSlideIndex: activeSlide, centerMode: true, onRequestChange: setActiveSlide, containerProps: {
                ...
                children: (jsx(ArrowLeftIcon, { className: "rotate-180 carouselControlIcon ".concat(rightControlIconClass) })),
                className: "carouselControl ".concat(controlClass, " right-0 ").concat(rightControlClass),
            }, backwardBtnProps: {
                children: (jsx(ArrowLeftIcon, { className: "carouselControlIcon ".concat(leftControlIconClass, " ") })),
...
var Dropdown = function (_a) {
    ...
    var _d = useState(value), selected = _d[0], setSelected = _d[1];
    var _e = useState(null), inputValue = _e[0], setInputValue = _e[1];
    ...
    var generateList = function () {
        ...
        items === null || items === void 0 ? void 0 : items.forEach(function (item, index) {
            return (!inputValue ||
                ...
                data.push(jsx("li", __assign({ onClick: function () { return selectValue(item); }, className: "dropdownItem ".concat(itemClassName) }, { children: itemTemplate
                        ? itemTemplate(item)
                        : itemLabel
                            ? item[itemLabel]
                            : item }), index));
        });
        return data.length > 0 ? (data) : (jsx("div", __assign({ className: "p-2 flex items-center justify-center font-semibold" }, { children: "Not found" })));
    };
    return (jsxs("div", __assign({ className: "relative ".concat(className) }, { children: [label && jsx("label", __assign({ className: "form-label" }, { children: label })), jsxs("div", __assign({ className: "relative" }, { children: [jsxs("div", __assign({ className: "flex items-stretch  border border-gray-500 rounded-md overflow-hidden z-50 relative bg-white" }, { children: [jsx("input", { disabled: !editable, className: "flex-1 p-2 focus:outline-none ".concat(inputClassName), placeholder: placeholder, onChange: changeValue, value: inputValue || selected || "" }), clearable && (jsx("div", __assign({ className: "w-5 h-5 cursor-pointer flex items-center justify-center rounded-full bg-gray-300 text-white my-auto mr-2" }, { children: jsx(XMarkIcon, { className: "w-4" }) }))), !hideDropdownBtn && (jsx("div", __assign({ onClick: function () { return setVisible(function (pre) { return !pre; }); }, className: "w-12 flex items-center justify-center cursor-pointer border-l border-gray-300" }, { children: jsx(ChevronDownIcon, { className: "w-5" }) })))] })), jsx("ul", __assign({ className: "absolute top-full left-0 w-full shadow-lg bg-white transition-all duration-200 max-h-0 overflow-hidden ".concat(visible && "max-h-screen z-50") }, { children: generateList() })), visible && (jsx("div", { className: "w-screen h-screen fixed top-0 left-0 bg-transparent z-40", onClick: function () { return setVisible(false); } }))] })), errors && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var SwitchButton = function (props) {
    ...
    return (jsxs("label", __assign({ className: "switchButtonContainer ".concat(checked ? "bg-primary " : "bg-gray-600", " ").concat(className) }, { children: [jsx("input", { type: "checkbox", className: "opacity-0 w-0 h-0", checked: checked, onChange: onChange }), jsx("span", { className: "switchButtonBubble  ".concat(checked && "before:translate-x-5", " ").concat(bubbleClassName) })] })));
};
...
var Accordion = function (_a) {
    ...
    return (jsx("div", __assign({ className: "accordionMain ".concat(className) }, { children: items.map(function (item, index) { return (jsxs("div", __assign({ className: "w-full" }, { children: [jsxs("div", __assign({ onClick: function () { return setActiveIndex(index === activeIndex ? null : index); }, className: "accordionTitle ".concat(titleClassName) }, { children: [item.title, dropDownBtnTemplate ? (dropDownBtnTemplate(index === activeIndex)) : (jsx(ChevronDownIcon, { className: "accordionIcon ".concat(dropDownIconClassName) }))] })), jsx("div", __assign({ className: "max-h-0 w-full overflow-hidden transition-all duration-200 ".concat(index === activeIndex && "max-h-screen") }, { children: jsx("div", __assign({ className: "accordionContainer ".concat(contentClassName) }, { children: item.content })) }))] }), index)); }) })));
};
...
var Modal = function (_a) {
    ...
    return visible ? (jsxs(Fragment, { children: [jsx("div", { onClick: hide, className: "fixed top-0 left-0 w-screen h-screen backdrop-blur-sm z-40 bg-black/20" }), jsxs("div", __assign({ className: "modalContainer ".concat(className) }, { children: [jsx("div", __assign({ className: "modalCloseBtn ".concat(closeBtnClassName), onClick: hide }, { children: jsx(XMarkIcon, { className: "w-4" }) })), children] }))] })) : (jsx(Fragment, {}));
};
...
var Paragraph = function (_a) {
    ...
    var paragraphClass = paragraphSize === "small"
        ...
        : paragraphSize === "medium"
            ? "paragraph-medium"
            : "paragraph-large";
    return jsx("p", __assign({ className: "paragraph ".concat(paragraphClass, " ").concat(className) }, { children: text }));
};
...
var Header = function (_a) {
    ...
    var finalClass = "".concat(className, " header header-").concat(level);
    return level === HeaderLevel.h1 ? (jsx("h1", __assign({ className: finalClass }, { children: text }))) : level === HeaderLevel.h2 ? (jsx("h2", __assign({ className: finalClass }, { children: text }))) : level === HeaderLevel.h3 ? (jsx("h3", __assign({ className: finalClass }, { children: text }))) : (jsx("h4", __assign({ className: finalClass }, { children: text })));
};
...
var ScrollList = function (_a) {
    ...
    return (jsx("div", __assign({ className: "scrollContainer no-scrollbar  ".concat(containerClassName) }, { children: jsx("div", __assign({ className: "flex items-center justify-start " }, { children: list })) })));
};
...
var Avatar = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "avatar ".concat(className) }, { children: [jsx("div", __assign({ className: "avatarImage ".concat(square && "avatarImage--square", " ").concat(imageClassName) }, { children: jsx("img", { src: image }) })), (description || name) && (jsxs("div", __assign({ className: "avatarDataContainer" }, { children: [name && jsx("p", __assign({ className: "avatarName ".concat(nameClassName) }, { children: name })), description && (jsx("p", __assign({ className: "avatarDescription ".concat(descriptionClassName) }, { children: description })))] })))] })));
};

var Tab = function (_a) {
    var activeId = _a.activeId, items = _a.items, onChange = _a.onChange, className = _a.className;
    var _b = useState(activeId), activeTab = _b[0], setActiveTab = _b[1];
    ...
    return (jsxs("div", __assign({ className: "tab ".concat(className) }, { children: [items === null || items === void 0 ? void 0 : items.map(function (item) { return (jsx("div", __assign({ className: "tabItem ".concat(item.id === activeTab && "tabItemActive"), onClick: function () { return changeSelectedItem(item.id); } }, { children: item.name }), item.id)); }), jsx("div", { style: {
...
var Rating = function (_a) {
    var maxRate = _a.maxRate, rate = _a.rate, containerClassName = _a.containerClassName, emptyStarClassName = _a.emptyStarClassName, fillStarClassName = _a.fillStarClassName, onClick = _a.onClick; __rest(_a, ["maxRate", "rate", "containerClassName", "emptyStarClassName", "fillStarClassName", "onClick"]);
    var generateStars = function () {
        var stars = [];
        for (var i = 0; i < maxRate; i++) {
            if (i < rate)
                stars.push(jsx(StarIcon, { onClick: onClick, className: "ratingFillStar ".concat(fillStarClassName) }));
            else
                stars.push(jsx(StarIcon$1, { onClick: onClick, className: "ratingEmptyStar ".concat(emptyStarClassName) }));
        }
        return stars;
    };
    return jsx("div", __assign({ className: "flex ".concat(containerClassName) }, { children: generateStars() }));
};
