...
var Dropdown = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "relative ".concat(containerClassName) }, { children: [label && jsx("label", __assign({ className: "form-label" }, { children: label })), jsxs("div", __assign({ className: "relative" }, { children: [jsxs("div", __assign({ className: "flex items-stretch  border border-gray-500 rounded-md overflow-hidden z-50 relative bg-white ".concat(className) }, { children: [jsx("input", { disabled: !editable, className: "flex-1 p-2 focus:outline-none ".concat(inputClassName), placeholder: placeholder, onChange: changeValue, value: inputValue || selected || "" }), clearable && (jsx("div", __assign({ className: "w-5 h-5 cursor-pointer flex items-center justify-center rounded-full bg-gray-300 text-white my-auto mr-2" }, { children: jsx(XMarkIcon, { className: "w-4" }) }))), !hideDropdownBtn && (jsx("div", __assign({ onClick: function () { return setVisible(function (pre) { return !pre; }); }, className: "w-12 flex items-center justify-center cursor-pointer border-l border-gray-300 ".concat(dropdownIconContainerClassName) }, { children: jsx(ChevronDownIcon, { className: "w-5 ".concat(dropdownIconClassName) }) })))] })), jsx("ul", __assign({ className: "absolute top-full left-0 w-full shadow-lg bg-white transition-all duration-200 max-h-0 overflow-hidden ".concat(visible && "max-h-screen z-50") }, { children: generateList() })), visible && (jsx("div", { className: "w-screen h-screen fixed top-0 left-0 bg-transparent z-40", onClick: function () { return setVisible(false); } }))] })), errors && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
