...
var Checkbox = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "flex items-center ".concat(className) }, { children: [jsxs("div", __assign({ className: "relative" }, { children: [jsx("input", __assign({ id: name, name: name, placeholder: label, type: "checkbox", checked: inChecked, onChange: changeCheck }, props, { className: "form-checkbox ".concat(inputClassName, " ").concat(errors.length ? "form-input-error" : "") })), inChecked && (jsx("label", __assign({ htmlFor: name }, { children: icon || (jsx(CheckIcon, { className: "absolute cursor-pointer top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white w-4 font-bold" })) })))] })), label && (jsx("label", __assign({ className: "form-label ml-2 ".concat(labelClassName), htmlFor: name }, { children: label }))), child && child, errors.length > 0 && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var Input = function (_a) {
    ...
    return (jsxs("div", __assign({ className: className }, { children: [label && (jsx("label", __assign({ className: "form-label", htmlFor: name }, { children: label }))), jsxs("div", __assign({ className: "flex" }, { children: [iconPosition !== "right" && icon, jsx("input", __assign({}, props, { value: inValue, id: name, onChange: changeEvent, className: "form-input ".concat(inputClassName, " ").concat(errors.length ? "form-input-error" : "") })), iconPosition === "right" && icon] })), child && child, errors.length > 0 && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var Carousel = function (_a) {
    ...
    return (jsx("div", __assign({ className: "carouselContainer ".concat(containerClassName) }, { children: jsx(SimplyCarousel, __assign({ preventScrollOnSwipe: true, swipeTreshold: 60, activeSlideIndex: activeSlide, centerMode: centerMode, onRequestChange: setActiveSlide, containerProps: {
                ...
                children: controlIcon ? (controlIcon) : (jsx(ArrowLeftIcon, { className: " carouselControlIcon ".concat(rightControlIconClass) })),
                className: "carouselControl rotate-180 ".concat(controlClass, " right-0 ").concat(rightControlClass),
            }, backwardBtnProps: {
                children: controlIcon ? (controlIcon) : (jsx(ArrowLeftIcon, { className: "carouselControlIcon ".concat(leftControlIconClass, " ") })),
...
var Dropdown = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "relative ".concat(containerClassName) }, { children: [label && jsx("label", __assign({ className: "form-label" }, { children: label })), jsxs("div", __assign({ className: "relative" }, { children: [jsxs("div", __assign({ onClick: function () { return setVisible(function (pre) { return !pre; }); }, className: "dropdown-container\n          ".concat(className, "\n          ").concat(errors ? "form-input-error" : "border-gray-500") }, { children: [headerTemplate ? (headerTemplate(selected)) : (jsx("input", { disabled: !editable, className: "flex-1 p-2 focus:outline-none ".concat(inputClassName), placeholder: placeholder, onChange: changeValue, value: inputValue || selected || "" })), clearable && (jsx("div", __assign({ className: "w-5 h-5 cursor-pointer flex items-center justify-center rounded-full bg-gray-300 text-white my-auto mr-2" }, { children: jsx(XMarkIcon, { className: "w-4" }) }))), !hideDropdownBtn && (jsx("div", __assign({ className: "w-12 flex items-center justify-center cursor-pointer border-l border-gray-300 ".concat(dropdownIconContainerClassName) }, { children: jsx(ChevronDownIcon, { className: "w-5 ".concat(dropdownIconClassName) }) })))] })), jsx("ul", __assign({ className: "absolute top-full left-0 w-full shadow-lg bg-white transition-all duration-200 max-h-0 overflow-hidden ".concat(visible && "max-h-screen z-50") }, { children: generateList() })), visible && (jsx("div", { className: "w-screen h-screen fixed top-0 left-0 bg-transparent z-40", onClick: function () { return setVisible(false); } }))] })), errors && jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var Accordion = function (_a) {
    ...
    return (jsx("div", __assign({ className: "accordionMain ".concat(className) }, { children: items.map(function (item, index) { return (jsxs("div", __assign({ className: "w-full \n          ".concat(containerClassName, "\n          ").concat(index === activeIndex && containerOpenClassName) }, { children: [jsxs("div", __assign({ onClick: function () { return changeIndex(index); }, className: "accordionTitle ".concat(titleClassName, " ").concat(index === activeIndex && titleOpenClassName) }, { children: [item.title, dropDownBtnTemplate ? (dropDownBtnTemplate(index === activeIndex)) : (jsx(ChevronDownIcon, { className: "accordionIcon ".concat(dropDownIconClassName, " ").concat(index === activeIndex && dropDownIconOpenClassName) }))] })), jsx("div", __assign({ className: "max-h-0 w-full overflow-hidden transition-all duration-200 ".concat(index === activeIndex && "max-h-screen") }, { children: jsx("div", __assign({ className: "accordionContainer ".concat(contentClassName, " ").concat(index === activeIndex && contentOpenClassName) }, { children: item.content })) }))] }), index)); }) })));
};
...
var Modal = function (_a) {
    ...
    return visible ? (jsxs(Fragment, { children: [jsx("div", { onClick: hide, className: "fixed top-0 left-0 w-screen h-screen backdrop-blur-sm z-[100] bg-black/20" }), jsxs("div", __assign({ className: "modalContainer ".concat(className) }, { children: [jsx("div", __assign({ className: "modalCloseBtn ".concat(closeBtnClassName), onClick: hide }, { children: jsx(XMarkIcon, { className: "w-4" }) })), children] }))] })) : (jsx(Fragment, {}));
};
...
var Header = function (_a) {
    ...
    return level === HeaderLevel.h1 ? (jsx("h1", __assign({ className: "".concat(finalClass, " header-h1") }, { children: text }))) : level === HeaderLevel.h2 ? (jsx("h2", __assign({ className: "".concat(finalClass, " header-h2") }, { children: text }))) : level === HeaderLevel.h3 ? (jsx("h3", __assign({ className: "".concat(finalClass, " header-h3") }, { children: text }))) : (jsx("h4", __assign({ className: "".concat(finalClass, " header-h4") }, { children: text })));
};
...
var Rating = function (_a) {
    ...
    var generateStars = function () {
        ...
        var _loop_1 = function (i) {
            if (i < rate)
                stars.push(jsx(StarIcon, { onClick: function () { return onClick && onClick(i); }, className: "ratingFillStar ".concat(fillStarClassName) }, i));
            else
                stars.push(jsx(StarIcon$1, { onClick: function () { return onClick && onClick(i); }, className: "ratingEmptyStar ".concat(emptyStarClassName) }, i));
        };
