...
var Checkbox = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "flex items-center ".concat(className) }, { children: [jsxRuntime.jsxs("div", __assign({ className: "relative" }, { children: [jsxRuntime.jsx("input", __assign({ id: name, name: name, placeholder: label, type: "checkbox", checked: inChecked, onChange: changeCheck }, props, { className: "form-checkbox ".concat(inputClassName, " ").concat(errors.length ? "form-input-error" : "") })), inChecked && (jsxRuntime.jsx("label", __assign({ htmlFor: name }, { children: jsxRuntime.jsx(solid.CheckIcon, { className: "absolute cursor-pointer top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white w-4 font-bold" }) })))] })), label && (jsxRuntime.jsx("label", __assign({ className: "form-label ml-2 ".concat(labelClassName), htmlFor: name }, { children: label }))), child && child, errors.length > 0 && jsxRuntime.jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var Carousel = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "carouselContainer ".concat(containerClassName) }, { children: jsxRuntime.jsx(SimplyCarousel__default["default"], __assign({ preventScrollOnSwipe: true, swipeTreshold: 60, activeSlideIndex: activeSlide, centerMode: true, onRequestChange: setActiveSlide, containerProps: {
                ...
                children: (jsxRuntime.jsx(solid.ArrowLeftIcon, { className: "rotate-180 carouselControlIcon ".concat(rightControlIconClass) })),
                className: "carouselControl ".concat(controlClass, " right-0 ").concat(rightControlClass),
            }, backwardBtnProps: {
                children: (jsxRuntime.jsx(solid.ArrowLeftIcon, { className: "carouselControlIcon ".concat(leftControlIconClass, " ") })),
...
var Dropdown = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "relative ".concat(className) }, { children: [label && jsxRuntime.jsx("label", __assign({ className: "form-label" }, { children: label })), jsxRuntime.jsxs("div", __assign({ className: "relative" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "flex items-stretch  border border-gray-500 rounded-md overflow-hidden z-50 relative bg-white" }, { children: [jsxRuntime.jsx("input", { disabled: !editable, className: "flex-1 p-2 focus:outline-none ".concat(inputClassName), placeholder: placeholder, onChange: changeValue, value: inputValue || selected || "" }), clearable && (jsxRuntime.jsx("div", __assign({ className: "w-5 h-5 cursor-pointer flex items-center justify-center rounded-full bg-gray-300 text-white my-auto mr-2" }, { children: jsxRuntime.jsx(solid.XMarkIcon, { className: "w-4" }) }))), !hideDropdownBtn && (jsxRuntime.jsx("div", __assign({ onClick: function () { return setVisible(function (pre) { return !pre; }); }, className: "w-12 flex items-center justify-center cursor-pointer border-l border-gray-300" }, { children: jsxRuntime.jsx(solid.ChevronDownIcon, { className: "w-5" }) })))] })), jsxRuntime.jsx("ul", __assign({ className: "absolute top-full left-0 w-full shadow-lg bg-white transition-all duration-200 max-h-0 overflow-hidden ".concat(visible && "max-h-screen z-50") }, { children: generateList() })), visible && (jsxRuntime.jsx("div", { className: "w-screen h-screen fixed top-0 left-0 bg-transparent z-40", onClick: function () { return setVisible(false); } }))] })), errors && jsxRuntime.jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
...
var Modal = function (_a) {
    ...
    return visible ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { onClick: hide, className: "fixed top-0 left-0 w-screen h-screen backdrop-blur-sm z-40 bg-black/20" }), jsxRuntime.jsxs("div", __assign({ className: "modalContainer ".concat(className) }, { children: [jsxRuntime.jsx("div", __assign({ className: "modalCloseBtn ".concat(closeBtnClassName), onClick: hide }, { children: jsxRuntime.jsx(solid.XMarkIcon, { className: "w-4" }) })), children] }))] })) : (jsxRuntime.jsx(jsxRuntime.Fragment, {}));
};
...
var Header = function (_a) {
    ...
    return level === HeaderLevel.h1 ? (jsxRuntime.jsx("h1", __assign({ className: finalClass }, { children: text }))) : level === HeaderLevel.h2 ? (jsxRuntime.jsx("h2", __assign({ className: finalClass }, { children: text }))) : level === HeaderLevel.h3 ? (jsxRuntime.jsx("h3", __assign({ className: finalClass }, { children: text }))) : (jsxRuntime.jsx("h4", __assign({ className: finalClass }, { children: text })));
};
...
var Rating = function (_a) {
    ...
    var generateStars = function () {
        ...
        for (var i = 0; i < maxRate; i++) {
            if (i < rate)
                stars.push(jsxRuntime.jsx(solid.StarIcon, { onClick: onClick, className: "ratingFillStar ".concat(fillStarClassName) }));
            else
                stars.push(jsxRuntime.jsx(outline.StarIcon, { onClick: onClick, className: "ratingEmptyStar ".concat(emptyStarClassName) }));
        }
        return stars;
    };
