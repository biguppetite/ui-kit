...
var Input = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: className }, { children: [label && (jsxRuntime.jsx("label", __assign({ className: "form-label", htmlFor: name }, { children: label }))), jsxRuntime.jsxs("div", __assign({ className: "" }, { children: [iconPosition !== "right" && icon, jsxRuntime.jsx("input", __assign({}, props, { value: inValue, id: name, onChange: changeEvent, className: "form-input ".concat(inputClassName, " ").concat(errors.length ? "form-input-error" : "") })), iconPosition === "right" && icon] })), child && child, errors.length > 0 && jsxRuntime.jsx("div", __assign({ className: "form-error" }, { children: errors }))] })));
};
